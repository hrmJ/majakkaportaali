...
$con->q("INSERT INTO comments (service_id, theme, commentator, content, comment_time) VALUES (2, 'infoasia', 'Jari', 'Messun jälkeen lumitöitä tarjolla kaikille halukkaille', '2017-01-01 15:44:22')",Array(),"none");
$con->q("INSERT INTO comments (service_id, theme, commentator, content, comment_time) VALUES (2, 'infoasia', 'Jere', 'Raamista ei tällä viikolla.', '2017-03-07 11:40:22')",Array(),"none");
$con->q("INSERT INTO comments (service_id, theme, commentator, content, comment_time) VALUES (2, 'yleinen', 'Jere', 'Tämän viikon aikana on varmaan kerätty muutenkin kaikkea tavaraa, jota voidaan sitten tässä messussa jakaa sitä tarvitseville ja muutenkin pitkälti sanoisin, että pitkä oli tämä kommentti. Selvä. Jees.', '2017-03-05 15:40:22')",Array(),"none");
