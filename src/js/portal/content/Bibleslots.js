/**
 *
 * Moduuli yhden messun raamattusloteista
 *
 */
var BibleSlots = function(){
     ...
     *
     * @param details_tab Messun tiedot -välilehti omana olionaan
     *
     **/
    function LoadDataToSegments(details_tab){
    ...
    /**
     *
     * Luo jokaisesta raamattuslotista oma olionsa
     *
     * @param slot_data ajax-response, joka sisältää tiedot tähän messuun tallennetuista raamatunkohdista
     *
     **/
    function InitializeSegments(slot_data){
        //TODO: multisongs!
